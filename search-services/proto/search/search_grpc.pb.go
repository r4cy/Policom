...
const (
	...
	Search_GetById_FullMethodName = "/search.Search/GetById"
)
...
type SearchClient interface {
	...
	GetById(ctx context.Context, in *ComicsRequest, opts ...grpc.CallOption) (*Comics, error)
}
...
func (c *searchClient) GetById(ctx context.Context, in *ComicsRequest, opts ...grpc.CallOption) (*Comics, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Comics)
	err := c.cc.Invoke(ctx, Search_GetById_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SearchServer interface {
	...
	GetById(context.Context, *ComicsRequest) (*Comics, error)
...
func (UnimplementedSearchServer) GetById(context.Context, *ComicsRequest) (*Comics, error) {
...
func _Search_GetById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ComicsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SearchServer).GetById(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Search_GetById_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SearchServer).GetById(ctx, req.(*ComicsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Search_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetById",
			Handler:    _Search_GetById_Handler,
		},
	},
