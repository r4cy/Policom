...
type Comics struct {
	...
	Imgdescription string                 `protobuf:"bytes,5,opt,name=imgdescription,proto3" json:"imgdescription,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *Comics) GetDescription() string {
	if x != nil {
...
func (x *Comics) GetImgdescription() string {
	if x != nil {
		return x.Imgdescription
	}
	return ""
}
...
func (x *ComicsRequest) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
const file_proto_search_search_proto_rawDesc = "" +
	...
	"\x06phrase\x18\x02 \x01(\tR\x06phrase\"\x8a\x01\n" +
	"\x06Comics\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x14\n" +
	"\x05title\x18\x02 \x01(\tR\x05title\x12\x10\n" +
	"\x03url\x18\x03 \x01(\tR\x03url\x12 \n" +
	"\vdescription\x18\x04 \x01(\tR\vdescription\x12&\n" +
	"\x0eimgdescription\x18\x05 \x01(\tR\x0eimgdescription\"K\n" +
	"\vSearchReply\x12&\n" +
	"\x06comics\x18\x01 \x03(\v2\x0e.search.ComicsR\x06comics\x12\x14\n" +
	"\x05total\x18\x02 \x01(\x03R\x05total\"\x1f\n" +
	"\rComicsRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id2\xe7\x01\n" +
	"\x06Search\x128\n" +
	...
	"\aISearch\x12\x15.search.SearchRequest\x1a\x13.search.SearchReply\"\x00\x122\n" +
	"\aGetById\x12\x15.search.ComicsRequest\x1a\x0e.search.Comics\"\x00B\x1fZ\x1dyadro.com/course/proto/searchb\x06proto3"
...
var file_proto_search_search_proto_goTypes = []any{
	...
	(*ComicsRequest)(nil), // 3: search.ComicsRequest
...
var file_proto_search_search_proto_depIdxs = []int32{
	...
	3, // 4: search.Search.GetById:input_type -> search.ComicsRequest
	...
	1, // 8: search.Search.GetById:output_type -> search.Comics
